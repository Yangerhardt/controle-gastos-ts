...
form === null || form === void 0 ? void 0 : form.addEventListener("submit", (event) => {
    ...
    transacoes = transacao.adicionaNaLista(id++, nome.value, valor.valueAsNumber);
    atualizaSaldo.atualiza(transacoes);
    novoElemento.limpaFomrulario(nome, valor);
    const deletaImagem = document.querySelector(".deleta-btn");
    const removerElemento = new RemoveElemento();
    deletaImagem.addEventListener("click", () => removerElemento.removerItem(transacoes));
});
